...
from backend.app.storage import save_linked_vendor
...
async def list_cached_vehicles(user_id: str = Depends(require_api_key)):
    ...
    """
    from backend.app.storage import get_all_cached_vehicles
    import json
...
async def get_user_info(
    ...
    from backend.app.storage import get_user, get_linked_vendors
